    ...
    <div className="bg-gray-100 py-10 px-5 lg:px-20 font-serif relative" id="team">
        <div className="flex flex-col lg:flex-row items-center lg:items-start justify-between">
            <div className="w-full lg:w-1/2 order-2 lg:order-2 mt-8 lg:mt-0">
                <img src={sarah1} alt="chef_image" className="w-full" />
            </div>
            <div className="w-full lg:w-1/2 order-1 lg:order-1 lg:ml-5">
                <div className="mb-10 flex flex-col lg:flex-col items-center lg:items-start justify-between">
                ...
                <div className="flex flex-col lg:flex-row items-start mb-8">
                    <div className="flex flex-col items-center justify-left">
                        ...
                        <p className="text-base lg:text-lg mt-4 lg:ml-10 ">It is upon us all to take bold steps towards a greener future. Our actions today will shape the world of tomorrow. Join us in our journey to protect and nurture the Earth, our only home.</p>
                    </div>
                </div>
